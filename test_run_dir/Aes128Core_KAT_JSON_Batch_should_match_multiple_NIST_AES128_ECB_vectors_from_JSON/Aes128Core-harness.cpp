...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/crypto-chisel-llm/test_run_dir/Aes128Core_KAT_JSON_Batch_should_match_multiple_NIST_AES128_ECB_vectors_from_JSON/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/crypto-chisel-llm/test_run_dir/Aes128Core_KAT_JSON_Batch_should_match_multiple_NIST_AES128_ECB_vectors_from_JSON/Aes128Core.)";
